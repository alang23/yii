...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="static/home/Css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="static/home/Css/bootstrap-responsive.css" />
    <link rel="stylesheet" type="text/css" href="static/home/Css/style.css" />
    <script type="text/javascript" src="static/home/Js/jquery.js"></script>
  <!--  <script type="text/javascript" src="static/Js/jquery.sorted.js"></script>-->
    <script type="text/javascript" src="static/home/Js/bootstrap.js"></script>
    <script type="text/javascript" src="static/home/Js/ckform.js"></script>
...
<div class="container">
    ...
    <form class="form-signin" method="post" action="<?=$this->createUrl('');?>">
        ...
        <!--<input type="text" name="verify" class="input-medium" placeholder="验证码"><img src="index.php?d=home&c=login&m=getAuthcode"   onclick="getpicture();" id="valiCode" style=" padding-top:-30px;"> -->
